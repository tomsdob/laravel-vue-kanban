<div class="fixed left-0 inset-y-0 hidden flex lg:flex flex-col bg-gray-200 h-full shadow-lg md:shadow-none" id="sidebar">
    <div class="p-4 flex flex-col h-full">
        ...
        <div class="mt-auto flex justify-start items-center">
            <a href="#" class="p-2 flex justify-center items-center text-white bg-primary w-10 h-10 rounded-full">
            ...
            <a href="{{ route('logout') }}" class="ml-10 flex items-center text-gray-500 hover:text-primary transition-all duration-200">
